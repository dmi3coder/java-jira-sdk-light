...
public class Reporter implements Serializable
{
    ...
    private final static long serialVersionUID = 5072747215977588417L;
    ...
    public Reporter withSelf(String self) {
        this.self = self;
        return this;
    }
    ...
    public Reporter withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public Reporter withAccountId(String accountId) {
        this.accountId = accountId;
        return this;
    }
    ...
    public Reporter withEmailAddress(String emailAddress) {
        this.emailAddress = emailAddress;
        return this;
    }
    ...
    public Reporter withAvatarUrls(AvatarUrls__ avatarUrls) {
        this.avatarUrls = avatarUrls;
        return this;
    }
    ...
    public Reporter withDisplayName(String displayName) {
        this.displayName = displayName;
        return this;
    }
    ...
    public Reporter withActive(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public Reporter withTimeZone(String timeZone) {
        this.timeZone = timeZone;
        return this;
    }
